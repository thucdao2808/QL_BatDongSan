...
namespace DataAccess.HeThong.Model
{
    ...
    public partial class QL_BatDongSanEntities1 : DbContext
    {
        public QL_BatDongSanEntities1()
            : base("name=QL_BatDongSanEntities1")
        {
        }
        ...
        public virtual DbSet<BDS> BDS { get; set; }
